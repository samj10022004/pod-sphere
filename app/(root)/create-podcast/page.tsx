  ...
  async function onSubmit(data: z.infer<typeof formSchema>) {
    try {
      ...
      if (!audioUrl||!imageUrl||!voiceType) {
        toast({
          title:"please generate auido and image"
        })
          ...
          <div className="flex flex-col gap-[30px] border-b border-black-5 pb-10" >
            ...
            render={({ field }) => (
              <FormItem className="flex flex-col gap-2.5">
                ...
                <FormControl>
                  <Input className="input-class focus-visible:ring-orange-1" placeholder="PodCast here.." {...field} />
                </FormControl>
            ...
            <Select onValueChange={(value)=>setVoiceType(value)}>
              ...
              <SelectContent className="text-16 border-none bg-black-1 font-bold text-white-1 focus:ring-orange-1">
                {voiceCategories.map((category)=>{
                  return <SelectItem key={category} value={category} className="capitalize focus:bg-orange-1">
                    {category}
                  </SelectItem>
                })}
                </SelectContent>
